...
class Address{
    constructor(streetAddress1, streetAddress2, postalCode, city, state, country){
    ...
    fromData(addressObj){
        this._streetAddress1 = addressObj._streetAddress1;
        this._streetAddress2 = addressObj._streetAddress2;
        this._postalCode = addressObj._postalCode;
        this._city = addressObj._city;
        this._state = addressObj._state;
        this._country = addressObj._country;
    }
}
